...
public class singin_activity extends AppCompatActivity {private static final String TAG = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(singin_activity.this, reset_password.class));
            }
        });
                        ...
                        .addOnCompleteListener(singin_activity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    Intent intent = new Intent(singin_activity.this, Apply_Now.class);
